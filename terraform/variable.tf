...
variable "eb_application_version_name" {
  type = string
  default = ""
}

variable "eb_application_description" {
  type = string
  default = "Beanstalk New app version"
}

variable "eb_source_bucket_name" {
  type = string
  default = ""
}

variable "eb_source_bucket_key" {
  type = string
  default = ""
}